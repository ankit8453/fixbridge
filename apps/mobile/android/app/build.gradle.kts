...
android {
    namespace = "com.fixbridge.fixbridge"
    compileSdk = flutter.compileSdkVersion

    // No `ndkVersion` here on purpose. Setting it makes Gradle fetch that exact
    // NDK through sdkmanager, which this Android Studio has deprecated — the
    // tool crashes instead of downloading. Nothing in this app needs the NDK:
    // it is pure Dart and Kotlin, and the one dependency that pulled in a
    // native bridge (connectivity_plus, via jni) has been dropped because it
    // was never actually used. Adding a plugin with native code will bring
    // this back; deal with it then rather than pinning speculatively.
    ...
    defaultConfig {
        ...
        applicationId = "com.fixbridge.fixbridge"
