...
class FixBridgeApp extends ConsumerStatefulWidget {
  const FixBridgeApp({super.key});

  @override
  ConsumerState<FixBridgeApp> createState() => _FixBridgeAppState();
}

class _FixBridgeAppState extends ConsumerState<FixBridgeApp> {
  @override
  void initState() {
    super.initState();
