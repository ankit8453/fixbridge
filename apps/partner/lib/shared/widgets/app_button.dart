  ...
  Widget build(BuildContext context) {
    final (bg, fg, hasBorder, shadow) = switch (kind) {
      ...
      AppButtonKind.accent => (
          // The one consequential tap on a screen. In the customer app that
          // is approving a price; here it is accepting a job, which is green
          // because it is money arriving.
