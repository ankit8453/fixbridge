...
import type { BookingTimelineResponse } from '@/components/admin/lib/types';
import { AdminLink } from '@/components/admin/AdminLink';
import { BookingTimeline } from '@/components/admin/BookingTimeline';
import { ConfirmDialog, noteField, reasonField } from '@/components/admin/ConfirmDialog';
...
/** Ported from apps/admin/src/pages/BookingDetailPage.tsx. */
  ...
  return (
    <>
      <PageHeader
        ...
        actions={
          <AdminLink className="text-sm text-blue-700 hover:underline" href="/bookings">
            ← Back to search
          </AdminLink>
        }
      />
    ...
    >
      <dl>
        <DetailRow label="Status">
          ...
          {data.otpLocked ? (
            <span className="ml-2">
              <Badge tone="bad">handshake locked</Badge>
            </span>
          ) : null}
        </DetailRow>
        ...
        <DetailRow label="Technician">
          {booking.provider ? (
            <AdminLink
              ...
              href={`/providers/${booking.provider.userId}`}
            >
