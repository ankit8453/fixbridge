...
import type { ProviderDetail } from '@/components/admin/lib/types';
...
import { Badge, Button, Card, DetailRow, QueryState, Table, Td, Th, Tr } from '@/components/ui';
 ...
 * apps/admin/src/pages/ProviderDetailPage.tsx.
 *
  ...
  return (
    <>
      <PageHeader
        title="Technician"
        actions={
          <AdminLink className="text-sm text-blue-700 hover:underline" href="/providers">
            ← Back to the list
          </AdminLink>
        }
      />
  ...
  return (
    <Card title="Wallet">
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-3">
        ...
        />
        <StatTile label="Net" value={formatPaise(provider.balance.netPaise)} href="/money" />
      </div>
