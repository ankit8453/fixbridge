...
import { VerificationLevelCard } from '@/components/partner/VerificationLevelCard';
import { fetchMyCases } from '@/components/partner/lib/api';
...
/**
 * The verification center (PHASE12_PROMPT.md §C.2) — four independent levels
 * rendered as a ladder, so passing one visibly moves a technician closer to
 * `VERIFIED` rather than each level feeling like an isolated form.
 */
