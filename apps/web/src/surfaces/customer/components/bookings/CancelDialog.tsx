...
import { useCancelBooking } from '@/surfaces/customer/data/bookings';
import { CUSTOMER_CANCEL_REASONS, type CustomerCancelReason } from '@/surfaces/customer/data/types';
...
/** Ported from `legacy-next-src/components/customer/bookings/CancelDialog.tsx`. */
