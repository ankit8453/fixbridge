...
/**
 * "Cash collected" (PHASE12_PROMPT.md §C.3) — the one thing a technician can
 * do unilaterally about money, so the API sends the customer a notification
 * the moment it happens (docs/API.md: "marking cash is the one thing a
 * technician can do unilaterally about money, so it gets sunlight"). The
 * confirmation step here exists for the same reason: a mis-tap that records
 * the wrong amount is not something either side can quietly undo afterwards.
 */
