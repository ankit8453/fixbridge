 ...
 * (PHASE12_PROMPT.md §C.1). Monday–Friday evenings plus a full Sunday is the
 * shape almost every part-time mistri actually works; typing six windows by
 * hand on a phone keyboard is the thing this button exists to skip.
 */
...
export function AvailabilityEditor({
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <p className="text-xs text-slate-500">{t('partner.availability.presetHint')}</p>
                ...
                {windows.map((window) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="min-h-touch px-2 text-sm font-medium text-red-700"
                    >
