 ...
 * send"). Totals are recomputed on every keystroke with the same arithmetic
 * the server uses (`lib/quote-math.ts`) so a technician sees the real number
 * — and any cap violation — before tapping send, not after a round trip on a
 * job site's patchy signal.
 */
