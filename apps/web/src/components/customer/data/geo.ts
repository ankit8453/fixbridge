 ...
 * in this v1 — there is no map picker and no geocode-as-you-type (see
 * PHASE12_PROMPT.md: "map-less v1 ... honest about it"). The address form
 * says so explicitly rather than implying a pin was placed on a map.
 */
