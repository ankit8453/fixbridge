 ...
 * source of payment truth (see `docs/API.md` "Payments" section); this
 * function's whole job is to read that truth back out of the list rather than
 * trust anything client-side, which is exactly what makes the closed-browser
 * case safe: reopening this booking recomputes the same state from the same
 * server data, whether or not this browser was there for the checkout.
 */
