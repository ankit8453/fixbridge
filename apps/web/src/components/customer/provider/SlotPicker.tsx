...
import {
  ...
  istDayOfWeekKey,
  istTime,
} from '@/components/customer/data/ist-date';
 ...
 * purpose: `ProviderProfile` owns the `useProviderSlots` query, which keeps
 * this component testable with plain fixture data (see
 * `__tests__/SlotPicker.test.tsx`) rather than a mocked network call.
 */
