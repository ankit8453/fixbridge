...
import { useRaiseComplaint } from '@/components/customer/data/complaints';
import { COMPLAINT_CATEGORIES, type ComplaintCategory } from '@/components/customer/data/types';
        ...
        <Button
          ...
          onClick={() =>
            raise.mutate(
              ...
              {
                onSuccess: () =>
                  router.push(buildLocalizedHref(locale, `/app/bookings/${bookingId}`)),
              },
            )
          }
        >
