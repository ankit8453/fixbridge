...
/**
 * The "what needs my attention" wall.
 *
 * Queues first, money last, and every queue depth is a link to the list behind
 * it. A dashboard that opens on last month's GMV is a dashboard ops close and
 * never reopen — the number that matters at 9am is how many people are waiting.
 */
...
function Summary({ summary }: { summary: AdminSummary }) {
  ...
  const tiles = [
    ...
    },
    {
      ...
      to: '/providers?pending_approval=true',
