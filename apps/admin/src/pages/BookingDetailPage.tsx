...
import { fetchBookingTimeline, opsCancelBooking, unlockBookingOtp } from '../api/endpoints';
...
export function BookingDetailPage() {
  ...
  const invalidate = [['bookings'], ['summary']];
  ...
  return (
    <>
      <PageHeader
        ...
        actions={
          <Link className="text-sm text-blue-700 hover:underline" to="/bookings">
            ← Back to search
          </Link>
        }
      />
