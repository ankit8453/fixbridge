...
describe('resolving a complaint', () => {
  it('requires both a severity and a note, then sends them together', async () => {
    ...
    renderAt(<ComplaintDetailPage />, {
      path: '/complaints/:complaintId',
      route: '/complaints/complaint-1',
    });
     ...
     * reason: the severity is what the trust engine acts on (severe suspends
     * somebody), and the note is what an appeal is answered from.
     */
